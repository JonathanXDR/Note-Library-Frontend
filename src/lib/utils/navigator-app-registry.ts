...
export type NavigatorAppRegistrationObject = {
  type: 'NavigatorApp'
...
export const reactNavigatorAppDeferredRegistry =
  new DeferredRegistry<NavigatorAppRegistrationObject>()
