...
import type { ToastRole, ToastType } from '../components/Toast'
...
export const InternalToastsContext = createContext<InternalToastsContextType>({
  toasts: [],
  persistedToast: null,
})
...
export function ToastContextProvider({ children }: ToastContextProviderType) {
  ...
  return (
    <ToastContext.Provider value={contextValue}>
      <InternalToastsContext.Provider value={internalToastsContext}>
        {children}
