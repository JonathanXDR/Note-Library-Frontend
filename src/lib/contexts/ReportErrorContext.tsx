...
import { handleIfNotReported } from '../providers/RouterErrorBoundary'

const ReportErrorContext = createContext<typeof reportError | null>(null)

export const ReportErrorContextProvider = memo(
  function ReportErrorContextProvider({
    ...
    return (
      <ReportErrorContext.Provider value={internalReportError}>
        {children}
